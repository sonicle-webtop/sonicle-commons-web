 ...
 * @author dnllr
 */
public class ExtGridFilterNumeric extends ExtGridFilter {
	
	public String comparison = null;
	public Number value = null;
	
	public ExtGridFilterNumeric() {
		super();
	}
	
	public ExtGridFilterNumeric(String type, String field, String comparison, Number value) {
		super(type, field);
